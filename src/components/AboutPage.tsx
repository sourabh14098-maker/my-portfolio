    ...
    <section id="about" className="section-page relative z-10">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-12">
          ...
          <Reveal delay={0.1}>
            <div className="premium-card rounded-2xl overflow-hidden font-mono text-sm shadow-2xl">
              ...
              <div className="p-6 sm:p-8 bg-[#0a0a0a] text-zinc-400">
                <p className="mb-4">
          ...
          {/* Timeline */}
          <div className="relative border-l border-[rgba(255,255,255,0.1)] pl-8 sm:pl-10 ml-2 sm:ml-4 flex flex-col justify-center">
            {timelineData.map((event, index) => {
              ...
              return (
                <Reveal key={index} delay={index * 0.08} className="relative mb-12 last:mb-0 group/time">
                  <div className="absolute -left-[33px] sm:-left-[41px] top-1 w-4 h-4 rounded-full bg-[#050505] border border-[rgba(255,255,255,0.1)] flex items-center justify-center">
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${
                        isOngoing ? 'bg-[var(--color-accent)]' : isFuture ? 'bg-zinc-700' : 'bg-zinc-400'
                      }`}
                    />
                  </div>

                  <article className="premium-card rounded-2xl p-6 transition-all duration-300 hover:bg-[rgba(255,255,255,0.02)]">
                    ...
                    <h3 className="text-lg font-display font-medium text-white mb-2 group-hover/time:text-accent transition-colors">
                      {event.title}
                    </h3>
